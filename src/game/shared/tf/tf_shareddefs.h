...
enum
{
	...
	TF_LOADOUT_SLOT_HAT_PAINT,	 // TF_FIRST_PAINT_SLOT
	TF_LOADOUT_SLOT_MISC1_PAINT,
	TF_LOADOUT_SLOT_MISC2_PAINT,
	TF_LOADOUT_SLOT_MISC3_PAINT, // TF_LAST_PAINT_SLOT
...
#define TF_FIRST_PAINT_SLOT	TF_LOADOUT_SLOT_HAT_PAINT
#define TF_LAST_PAINT_SLOT TF_LOADOUT_SLOT_MISC3_PAINT
...
#define TF_PLAYER_PAINT_COUNT		4		// Total amount of all paint slots. This should always equal the amount of cosmetic slots.
