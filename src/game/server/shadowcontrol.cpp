...
private:
	...
	CNetworkVar( bool, m_bEnableWorldLightShadows );
};
...
BEGIN_DATADESC( CShadowControl )
	...
	DEFINE_KEYFIELD( m_bEnableWorldLightShadows, FIELD_BOOLEAN, "enableshadowsfromworldlights" ),
	...
	DEFINE_INPUT( m_bEnableWorldLightShadows,	FIELD_BOOLEAN, "SetShadowsFromWorldLightsEnabled" ),
...
IMPLEMENT_SERVERCLASS_ST_NOBASE(CShadowControl, DT_ShadowControl)
	...
	SendPropBool(SENDINFO(m_bEnableWorldLightShadows)),
END_SEND_TABLE()
...
CShadowControl::CShadowControl()
{
	...
	m_bEnableWorldLightShadows = true;
}
